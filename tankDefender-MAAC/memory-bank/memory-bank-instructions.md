...
* Use this checklist before any work:
  ...
  * [ ] Read `/tankDefender-MAAC/memory-bank/projectbrief.md`
  * [ ] Read `/tankDefender-MAAC/memory-bank/productContext.md`
  * [ ] Read `/tankDefender-MAAC/memory-bank/systemPatterns.md`
  * [ ] Read `/tankDefender-MAAC/memory-bank/techContext.md`
  * [ ] Read `/tankDefender-MAAC/memory-bank/activeContext.md`
  * [ ] Read `/tankDefender-MAAC/memory-bank/progress.md`
  * [ ] Read `/tankDefender-MAAC/memory-bank/copilot-rules.md`
  * [ ] Read any additional context files in `/tankDefender-MAAC/memory-bank/`
